...
<div class="row">
  <div class="col-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a  href="delete_food_items.php" class="list-group-item list-group-item-action list-group-item-dark active"  role="tab" aria-controls="messages">DELETE FOOD ITEMS</a>
